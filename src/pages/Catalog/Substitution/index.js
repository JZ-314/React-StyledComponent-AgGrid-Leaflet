...
import { FETCH_SUBSTITUTION_SUCCESS } from "../../../store/catalog/constants";

export default function Substitution({ data }) {
  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const result = await dispatch(fetchSubstitution(data.lexcode));
      setIsLoading(false);

      if (result.type === FETCH_SUBSTITUTION_SUCCESS) {
        // console.log(result);
